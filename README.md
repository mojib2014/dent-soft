...
## Features
- Login system
<img src="client/src/assets/images/dsLocalSignup.gif" width="400">
<img src="client/src/assets/images/dsLocalLogin.gif" width="400">
<img src="client/src/assets/images/dsGoogleLogin.gif" width="400">
...
### Users of the DS:
#### Administrator.
<img src="client/src/assets/images/dsDentistLogin.gif" width="400">
    Add a new doctor.
...
<img src="client/src/assets/images/dsDentistFileMethods.gif" width="400">
    Add a treatment.
    Add an external file.
#### Receptionist. 
<img src="client/src/assets/images/dsDentistEmailLookup.gif" width="400">
    Add new patient information.   
    Update patient information.
<img src="client/src/assets/images/dsDentistReservation.gif" width="400">
    Add a new appointment.
    Update an appointment.
    Delete an appointment.
<img src="client/src/assets/images/dsDentistNote.gif" width="400">
    Add notes for specific patients.
    Delete notes.
#### Patient.
<img src="client/src/assets/images/dsProfileEdit.gif" width="400">
    Edit basic profile information.
<img src="client/src/assets/images/dsPatientPage.gif" width="400">
